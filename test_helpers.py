# convert.py
# Helpers for converting python structures to and from 
# linked lists and trees that uses the classes in classes.py
# 
# You should use these methods ONLY FOR TESTING.
#
